                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="widget-item">
                            ...
                            <div class="widget-body">
                                <p>Chúng tôi tin rằng nước hoa không chỉ là sản phẩm, mà là cách kể câu chuyện và thể hiện phong cách riêng của bạn.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="widget-item">
                            ...
                            <div class="widget-body">
                                <address class="contact-block">
                                    <ul>
                                        <li><i class="pe-7s-home"></i> 36 Trịnh Văn Bô - Hà Nội </li>
                                        <li><i class="pe-7s-mail"></i> <a href="mailto:nguyenquanglinh0509@gmail.com">quanglinh0509@gmail.com</a></li>
                                        <li><i class="pe-7s-call"></i> <a href="tel:0386667598">0386667598</a></li>
                                    </ul>
                                </address>
                            </div>
                        </div>
                        ...
                        <div class="widget-item">
                            ...
                            <div class="widget-body">
                                <ul class="info-list">
                                    ...
                                    <li><a href="#"> khoản & Điều kiện</a></li>
                ...
                <div class="row align-items-center mt-20">
                    <div class="col-md-6">
                        <div class="newsletter-wrapper">
                            <h6 class="widget-title-text">Đăng ký nhận tin tức</h6>
                            <form class="newsletter-inner" id="mc-form">
                                <input type="email" class="news-field" id="mc-email" autocomplete="off" placeholder="Nhận địa chỉ email">
